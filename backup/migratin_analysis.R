...
# exclude documents (individual contributions) that contain less then 10 words. Hence, exclude short answers likely not of substantive meaning.
speeches <- speeches[speeches$terms>10,]

# subset data according to content focus of analysis
...
###########################################
## 3. General Databases & Considerations ##
###########################################
...
# Plot
k <- dygraph(don, main = "Prevalence of immigration debates", ylab =  "# of words spent on immigration-realted debates", xlab = "Year (by month)") %>%
