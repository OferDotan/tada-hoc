...
#####I think we could probably erase this graph/put in the appendix!
```{r}
...
## also this work freq graph -- either we use a word cloud or this, not both. I think word cloud gives a better sense of whats going on than this
```{r kwic_3, echo=FALSE}
...
From plotting sentiments toward immigration by party 
...
```
The topic found by the stm model are exclusive 
