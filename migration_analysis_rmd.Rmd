...
save(HoC_theta_data, file = "HoC_theta_data_6_topics_new_no_kwic.RData")
topic_6_first <- load("HoC_theta_data.RData")
topic_12_new <- load("HoC_theta_data_6_topics_new.RData")
topic_6_new_no_kwic <- load("HoC_theta_data_6_topics_new_no_kwic.RData")
...
# topic one evolution over time by party
...
####################################
# EXTRA CODE SENTIMENT & TOPICs/lm #
####################################
...
```{r lm to disern correlations between sentiment and topics}
